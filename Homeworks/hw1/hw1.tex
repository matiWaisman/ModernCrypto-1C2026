...
\begin{parts}
    ...
    \begin{solution}
        Asumiendo que se encripta una palabra de un solo caracter: \\ 
    ...
    \begin{solution}
        Si limitamos el espacio de mensajes a mensajes que no tengan caracteres repetidos, aun así el cifrado no es perfecto. Porque aunque no haya letras repetidas, el ciphertext sigue revelando información sobre la estructura del mensaje (por ejemplo, que todos los caracteres son distintos). 
        
        Entonces, mientras el mensaje tenga longitud mayor a 1, conocer el ciphertext permite descartar posibles plaintexts, por lo que no se cumple perfect secrecy. 
        
        Por lo tanto, el mayor espacio de mensajes $\mathcal{M}$ para el cual el mono-alphabetic substitution cipher es perfectamente secreto es el de mensajes de longitud 1.
    \end{solution}
\end{parts}
...
\begin{solution} 
    ...
    \begin{itemize}
        ...
        \item $\mathcal{K} = \{0,1\}^{t-1}$, con $1 \leq t < n$
